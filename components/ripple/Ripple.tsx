...
import {dissoc} from '../utils/utils';
...
export const ripple = (options:RippleProps = {}) => {
  const {
  ...
  return (ComposedComponent) => {
    class RippledComponent extends React.Component<RippleProps> {
      // static propTypes = {
    ...
    return themr(RIPPLE, theme)(RippledComponent);
  };
};

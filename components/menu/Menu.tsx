...
export class Menu extends React.Component<MenuProps> {
  ...
  private positionTimeoutHandle:number;
  private activateTimeoutHandle:Timer;
  ...
  renderItems() {
    return React.Children.map(this.props.children, (item:React.ReactElement<any>) => {
      if (!item) return item;
  ...
  render() {
    ...
    const className = cn([theme.menu, theme[this.state.position]], {

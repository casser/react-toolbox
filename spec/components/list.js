...
import {ListCheckbox} from '../../components/list/ListCheckbox';
      ...
      <section>
        ...
        <div style={listStyle}>
          <List selectable ripple>
            <ListSubHeader caption="Contacts"/>
            <ListItem
              avatar="https://avatars2.githubusercontent.com/u/1?v=3&s=460"
              caption="Alfonso Rocha"
              legend="Product Manager at Fon"
              rightIcon="star"
            />
            <ListItem
              avatar="https://avatars2.githubusercontent.com/u/2?v=3&s=460"
            ...
            />
            <ListItem
              avatar="https://avatars2.githubusercontent.com/u/3?v=3&s=460"
        ...
        <div style={listStyle}>
          <List>
            <ListItem
              avatar="https://avatars2.githubusercontent.com/u/654?v=3&s=460"
              caption="Alfonso Rocha"
              rightIcon="mail"
            />
            <ListItem
              avatar="https://avatars2.githubusercontent.com/u/87?v=3&s=460"
              caption="Javi Velasco"
              rightIcon="mail"
            />
            <ListItem
            ...
            />
            <ListItem
              avatar="https://avatars2.githubusercontent.com/u/11?v=3&s=460"
              caption="Tobias Van Schneider"
              rightIcon="mail"
            />
          </List>
        ...
        <div style={listStyle}>
          <List ripple selectable>
            ...
            <ListItem rightIcon="done" caption="Item with custom left icons">
              <FontIcon value="send"/>
              <Avatar image="https://avatars2.githubusercontent.com/u/123?v=3&s=460"/>
            </ListItem>
            ...
            <ListItem caption="Item with overlayed click events" onClick={() => console.log('clicked row')}>
              ...
              <Avatar
                image="https://avatars2.githubusercontent.com/u/845?v=3&s=460"
